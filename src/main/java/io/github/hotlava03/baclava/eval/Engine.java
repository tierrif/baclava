...
public enum Engine
{
    ...
    public static final Collection<String> DEFAULT_IMPORTS = Arrays.asList("net.dv8tion.jda.core.entities.impl", "net.dv8tion.jda.core.managers", "net.dv8tion.jda.core.entities", "net.dv8tion.jda.core", "java.lang", "java.io", "java.math", "java.eval", "java.eval.concurrent", "java.time");
