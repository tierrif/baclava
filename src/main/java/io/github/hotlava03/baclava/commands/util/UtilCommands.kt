...
object UtilCommands {
    ...
    fun registerAll() {
        ...
        commands.registerCommand(Base64EncodeCmd())
        commands.registerCommand(Base64DecodeCmd())
        commands.registerCommand(AvatarCmd())
        commands.registerCommand(TagsCmd())
        commands.registerCommand(TagCmd())
